...
export default function PontoEquilibrio() {
  ...
  const margemSeguranca = faturamentoDisponivel && pontoEquilibrioReais > 0 
    ? ((faturamentoMensal - pontoEquilibrioReais) / faturamentoMensal) * 100 
    : 0;

  // Mock data for categories and channels (future: integrate with real data)
  const categorias = [
    { nome: "Revenda Padrão", precoMedio: 4.50, unidadesEquilibrio: Math.round(pontoEquilibrioReais * 0.4 / 4.50) },
    { nome: "Food Service", precoMedio: 70.00, unidadesEquilibrio: Math.round(pontoEquilibrioReais * 0.3 / 70.00) },
    { nome: "B2C UFCSPA", precoMedio: 5.50, unidadesEquilibrio: Math.round(pontoEquilibrioReais * 0.2 / 5.50) },
    { nome: "Personalizados", precoMedio: 6.00, unidadesEquilibrio: Math.round(pontoEquilibrioReais * 0.1 / 6.00) }
  ];
