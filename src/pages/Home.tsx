...
import { BarChart3, Users, Calendar, Truck, Settings, TrendingUp, CheckCircle, Factory, Tag, PackageCheck, Layers, ShoppingBag, DollarSign, Cpu, Clock, AlertTriangle, ChevronRight, Activity } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {quickActions.map((action, index) => <Card key={index} className="hover:shadow-lg transition-all duration-200 cursor-pointer group" onClick={action.onClick}>
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-sm text-left">{action.description}</CardDescription>
              </CardHeader>
