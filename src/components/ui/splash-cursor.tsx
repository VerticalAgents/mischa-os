...
// Add TypeScript interfaces for our classes
...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    // @ts-ignore - we know this works in JS
    ...
    // Define Material class with TypeScript
    ...
    // Define Program class with TypeScript
    ...
    function compileShader(gl: WebGLRenderingContext, type: number, source: string, keywords?: string[]) {
