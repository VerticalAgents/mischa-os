    ...
    Tables: {
      agendamentos_clientes: {
        Row: {
          ...
          gestaoclick_nf_id: string | null
          gestaoclick_nf_status: string | null
      ...
      whatsapp_vinculos: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_vinculos_cliente_id_fkey"
            columns: ["cliente_id"]
            isOneToOne: false
            referencedRelation: "clientes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "whatsapp_vinculos_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
