...
-- Remover a constraint que está impedindo as baixas no estoque
ALTER TABLE public.movimentacoes_estoque_produtos DROP CONSTRAINT IF EXISTS ux_mov_prod_ref;

-- Atualizar a função process_entrega_safe para remover o ON CONFLICT
