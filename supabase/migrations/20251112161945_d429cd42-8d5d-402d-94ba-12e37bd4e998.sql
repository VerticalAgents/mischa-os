-- Atualiza função de geração de parcelas para seguir o dia da primeira parcela personalizada
...
BEGIN
  ...
  ELSE
    ...
    -- MUDANÇA PRINCIPAL: Usa o dia da data personalizada para todas as parcelas
  ...
  FOR v_contador IN 1..NEW.numero_parcelas LOOP
    ...
    -- Avançar para próximo mês usando o dia determinado (cartão ou personalizado)
